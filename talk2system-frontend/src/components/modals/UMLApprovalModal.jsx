...
export default function UmlApprovalModal({ onClose, onApprove }) {
  return (
      ...
      <div className="relative w-full max-w-md rounded-2xl bg-white dark:bg-gray-800 p-8 shadow-2xl border border-gray-200 dark:border-gray-700">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-8 leading-relaxed">
            This UML diagram has not been approved yet. We recommend final approval before exporting to ensure design consistency across all project artifacts.
          </p>
        </div>
