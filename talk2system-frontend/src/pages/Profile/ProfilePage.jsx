              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 pr-12 rounded-xl border-2 border-gray-200 dark:border-gray-600 dark:bg-gray-800 dark:text-white focus:ring-4 focus:ring-primary/10 focus:border-primary outline-none transition-all text-sm"
                    required
                  />
                  <button
                    type="button"
